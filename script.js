function printPage() {
    if (!isPrinting) {
        ...
        setTimeout(function() {
        isPrinting = false;
        }, 5000); // attendre 5 secondes avant de réactiver l'impression
    }
    }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const ChangeSpoil = document.querySelector('.IconSpoil')
    ...
    ChangeTheme.addEventListener('click', () => {
      if(Theme === 0){
        ...
        document.documentElement.style.setProperty('--background2', '#f1f1f1');
        ...
        document.documentElement.style.setProperty('--background2', '#262626');
